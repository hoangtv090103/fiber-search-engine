...
func Login() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div hx-ext=\"response-targets\" class=\"flex flex-col justify-center items-center\"><form class=\"flex flex-col justify-center items-center gap-5 py-5\" hx-post=\"/login\" hx-target=\"#feedback\" p hx-indicator=\"#indicator\" hx-target-errors=\"#feedback\"><label class=\"input input-bordered flex items-center gap-2 w-full\">Email <input name=\"email\" type=\"text\" class=\"grow\" placeholder=\"user@gmail.com\"></label> <label class=\"input input-bordered flex items-center gap-2 w-full\">Password <input name=\"password\" type=\"password\" class=\"grow\" placeholder=\"Password\"></label> <button class=\"btn\" type=\"submit\">Login</button><div id=\"indicator\" class=\"htmx-indicator\"><div class=\"flex justify-center items-center w-full\"><span class=\"loading loading-spinner loading-lg text-primary h-20 w-20\"></span></div></div><div id=\"feedback\"></div></form></div>")
